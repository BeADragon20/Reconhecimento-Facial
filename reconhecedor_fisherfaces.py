...
reconhecedor = cv2.face.FisherFaceRecognizer_create() #Cria o reconhecedor
reconhecedor.read("classificadorFisher.yml") #Utiliza o arquivo com o treinamento realizado
largura = 220
altura = 220
