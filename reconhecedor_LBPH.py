...
reconhecedor = cv2.face.LBPHFaceRecognizer_create() #Cria o reconhecedor
reconhecedor.read("classificadorLBPH.yml") #Utiliza o arquivo com o treinamento realizado
largura = 220
altura = 220
